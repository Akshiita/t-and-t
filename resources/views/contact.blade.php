              ...
              <div class="contact__card-box">
                <div class="contact__card-info">
                  ...
                  <div>
                    ...
                    <p class="contact__card-description">9630258741</p>
                  </div>
                </div>

                <button class="button contact__card-button" onclick="window.open('https://wa.me/9630258741', '_blank')">Call Now</button>
              </div>
              <div class="contact__card-box">
                <div class="contact__card-info">
                ...
                <button class="button contact__card-button" onclick="window.open('https://wa.me/9630258741', '_blank')">Chat Now</button>
              </div>
              <div class="contact__card-box">
                <div class="contact__card-info">
                ...
                <button class="button contact__card-button" onclick="window.open('https://wa.me/9630258741', '_blank')" >
                  Video Call Now
                </button>
              </div>
              <div class="contact__card-box">
                ...
                <button class="button contact__card-button" onclick="window.open('https://wa.me/9630258741', '_blank')">Message Now</button>
              </div>
            </div>
          </div>
        </div>
